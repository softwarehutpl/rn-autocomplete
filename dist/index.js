...
define("index", ["require", "exports", "react", "react-native", "react-native-svg", "react-native", "lodash"], function (require, exports, react_1, react_native_1, react_native_svg_1, react_native_2, lodash_1) {
    ...
    react_native_svg_1 = __importStar(react_native_svg_1);
    ...
    var Autocomplete = /** @class */ (function (_super) {
        ...
        Autocomplete.prototype.render = function () {
            ...
            if (this.state.inputValue.length > this.props.minChars) {
                if (Array.isArray(items) && items.length > 0) {
                    items = items.map(function (item) {
                        return react_1.default.createElement(react_native_1.Text, { style: styles.select, onPress: function () { return _this.selectItem(item); }, key: Math.random().toString(36).substr(2, 9) }, item[_this.props.labelField]);
                    });
                }
            }
            else {
            ...
            return (react_1.default.createElement(react_native_1.View, null,
                react_1.default.createElement(react_native_1.Modal, { animationType: "slide", transparent: false, visible: this.state.modalVisible },
                    react_1.default.createElement(react_native_1.View, { style: styles.backBtn },
                        react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: function () { return _this.toggleModal(); } },
                            react_1.default.createElement(react_native_svg_1.default, { height: "32", width: "32" },
                                react_1.default.createElement(react_native_svg_1.Path, { scale: "1.5", d: "M 10 5.3417969 C 9.744125 5.3417969 9.4879688 5.4412187 9.2929688 5.6367188 L 3.6367188 11.292969 C 3.2457187 11.683969 3.2457187 12.317031 3.6367188 12.707031 L 9.2929688 18.363281 C 9.6839688 18.754281 10.317031 18.754281 10.707031 18.363281 L 10.792969 18.277344 C 11.183969 17.886344 11.183969 17.253281 10.792969 16.863281 L 6.9296875 13 L 20 13 C 20.552 13 21 12.552 21 12 C 21 11.448 20.552 11 20 11 L 6.9296875 11 L 10.792969 7.1367188 C 11.183969 6.7457187 11.183969 6.1126563 10.792969 5.7226562 L 10.707031 5.6367188 C 10.511531 5.4412187 10.255875 5.3417969 10 5.3417969 z", fill: "#555" })))),
                    react_1.default.createElement(react_native_1.View, { style: styles.navbar },
                        react_1.default.createElement(react_native_1.View, { style: styles.inputContainer },
                            react_1.default.createElement(react_native_1.TextInput, { value: this.state.inputValue, style: styles.input, onChangeText: function (text) { return _this.setInputValue(text); }, onFocus: function () { return _this.setItems(); }, onSubmitEditing: function () { return _this.selectItem(); }, ref: function (input) { _this.modalTextInput = input; }, withRef: true, autoFocus: true }),
                            items ? react_1.default.createElement(react_native_1.View, { style: styles.selectsContainer }, items) : null),
                        react_1.default.createElement(react_native_1.View, { style: styles.delBtn },
                            react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: function () { return _this.clearInput(); } },
                                react_1.default.createElement(react_native_svg_1.default, { width: "32", height: "32" },
                                    react_1.default.createElement(react_native_svg_1.Line, { scale: "1.5", fill: "none", strokeWidth: "2", stroke: "#ff0033", x1: "4", y1: "4", x2: "20", y2: "20" }),
                                    react_1.default.createElement(react_native_svg_1.Line, { scale: "1.5", fill: "none", strokeWidth: "2", stroke: "#ff0033", x1: "20", y1: "4", x2: "4", y2: "20" })))))),
                react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: function () { return _this.toggleModal(); } },
                    react_1.default.createElement(react_native_1.View, { pointerEvents: "none" },
                        react_1.default.createElement(react_native_1.TextInput, { value: this.state.inputValue, style: styles.input, placeholder: "Insert value" })))));
        };
        return Autocomplete;
    }(react_1.Component));
